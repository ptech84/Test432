...
public class FreeCRMTest {
	...
	public void setExtent(){
		...
		extent.addSystemInfo("Host Name", "Praveen Mac");
	...
	@Test
	public void freeCrmTitleTest1(){
		extentTest = extent.startTest("freeCrmTitleTest1");
		String title = driver.getTitle();
		System.out.println(title);
		Assert.assertEquals(title,"#2 Free CRM software in the cloud for sales and service");
	}
